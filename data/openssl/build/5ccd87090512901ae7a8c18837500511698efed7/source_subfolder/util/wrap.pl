...
BEGIN {
    ...
    require '/opt/.conan/data/openssl/3.0.3/_/_/build/5ccd87090512901ae7a8c18837500511698efed7/source_subfolder/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/opt/.conan/data/openssl/3.0.3/_/_/build/5ccd87090512901ae7a8c18837500511698efed7/source_subfolder/test/fips-and-base.cnf';
    shift;
